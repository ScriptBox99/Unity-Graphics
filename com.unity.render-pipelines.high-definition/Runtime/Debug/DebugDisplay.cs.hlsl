...
#define FULLSCREENDEBUGMODE_VISIBILITY_BUFFER_INSTANCES (28)
#define FULLSCREENDEBUGMODE_VISIBILITY_BUFFER_PRIMITIVES (29)
#define FULLSCREENDEBUGMODE_VISIBILITY_BUFFER_MATERIALS (30)
#define FULLSCREENDEBUGMODE_VISIBILITY_BUFFER_BATCH (31)
#define FULLSCREENDEBUGMODE_VISIBILITY_FEATURE_TILE (32)
#define FULLSCREENDEBUGMODE_VISIBILITY_MATERIALS_TILE (33)
#define FULLSCREENDEBUGMODE_VISIBILITY_BUCKET_ID (34)
#define FULLSCREENDEBUGMODE_VISIBILITY_BUFFER_LIGHTING (35)
#define FULLSCREENDEBUGMODE_MAX_RENDERING_FULL_SCREEN_DEBUG (36)
#define FULLSCREENDEBUGMODE_MIN_MATERIAL_FULL_SCREEN_DEBUG (37)
#define FULLSCREENDEBUGMODE_VALIDATE_DIFFUSE_COLOR (38)
#define FULLSCREENDEBUGMODE_VALIDATE_SPECULAR_COLOR (39)
#define FULLSCREENDEBUGMODE_MAX_MATERIAL_FULL_SCREEN_DEBUG (40)
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_REFLECTIONS_PREV (41)
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_REFLECTIONS_ACCUM (42)
#define FULLSCREENDEBUGMODE_WORLD_SPACE_POSITION (43)
